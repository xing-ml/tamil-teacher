...
def main() -> int:
    ...
    cleaned_output = run_step(
        [
            ...
            collector_output,
            "--keywords-file",
            str(data_dir / "definitions" / "tamil_keywords_definitions.json"),
            "--output-dir",
            str(temp_dir),
    ...
    context_output = run_step(
        [
            ...
            cleaned_output,
            "--scenarios-file",
            str(data_dir / "definitions" / "scenario_definitions.json"),
            "--difficulty-file",
            str(data_dir / "definitions" / "difficulty_definitions.json"),
            "--cache-file",
            str(data_dir / "status" / "dialogue_used.json"),
            "--output-dir",
            str(temp_dir),
        ],
